        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('cards.relationship-graph') }}" class="text-primary-light hover:text-primary-accent">Graph</a>
                    <a href="{{ route('cards.create') }}" class="bg-primary-accent rounded hover:brightness-110 transition">New Card</a>
                </div>
            </div>
        </div>
    </nav>
